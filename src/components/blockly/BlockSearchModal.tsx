...
const ALL_ITEMS: SearchItem[] = [
  ...
  { id: 'control_spawn_type_at', type: 'block', blockType: 'control_spawn_type_at', label: 'spawn type at x y', category: 'Control', categoryColor: '#FFBF00' },
  ...
  { id: 'sensing_my_type', type: 'block', blockType: 'sensing_my_type', label: 'my type', category: 'Sensing', categoryColor: '#5CB1D6' },
  { id: 'sensing_type_of_object', type: 'block', blockType: 'sensing_type_of_object', label: "object's type", category: 'Sensing', categoryColor: '#5CB1D6' },
  { id: 'sensing_type_literal', type: 'block', blockType: 'sensing_type_literal', label: 'type', category: 'Sensing', categoryColor: '#5CB1D6' },
