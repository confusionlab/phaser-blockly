...
const ASSISTANT_BLOCK_CATALOG: readonly AssistantBlockCatalogEntry[] = [
  ...
  { type: 'control_switch_scene', category: 'Actions', kind: 'statement', summary: 'Switch to another scene (resume = continue where you left off, restart = start fresh)', inputNames: [], statementInputNames: [], fieldNames: ['SCENE'] },
