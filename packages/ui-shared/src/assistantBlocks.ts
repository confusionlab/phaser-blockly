...
const ASSISTANT_BLOCK_CATALOG: readonly AssistantBlockCatalogEntry[] = [
  ...
  { type: 'event_inventory_item_dropped', category: 'Events', kind: 'hat', summary: 'Runs when the selected inventory item is dropped on this object', inputNames: [], statementInputNames: ['NEXT'], fieldNames: ['ITEM'] },
  ...
  { type: 'inventory_move_to_inventory', category: 'Actions', kind: 'statement', summary: 'Move this object into the shared inventory', inputNames: [], statementInputNames: [], fieldNames: [] },
  { type: 'inventory_use_dropped_item', category: 'Actions', kind: 'statement', summary: 'Consume the inventory item that was just dropped here', inputNames: [], statementInputNames: [], fieldNames: [] },
