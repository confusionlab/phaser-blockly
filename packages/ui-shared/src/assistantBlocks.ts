...
const ASSISTANT_BLOCK_CATALOG: readonly AssistantBlockCatalogEntry[] = [
  ...
  { type: 'looks_speak', category: 'Looks', kind: 'statement', summary: 'Keep showing a speech bubble until it is stopped or replaced', inputNames: ['TEXT'], statementInputNames: [], fieldNames: [] },
  { type: 'looks_speak_and_stop', category: 'Looks', kind: 'statement', summary: 'Speak naturally and stop shortly after the last word', inputNames: ['TEXT'], statementInputNames: [], fieldNames: [] },
  ...
  { type: 'looks_target_speak', category: 'Looks', kind: 'statement', summary: 'Make another object keep showing a speech bubble', inputNames: ['TARGET', 'TEXT'], statementInputNames: [], fieldNames: [] },
  { type: 'looks_target_speak_and_stop', category: 'Looks', kind: 'statement', summary: 'Make another object speak naturally and stop shortly after the last word', inputNames: ['TARGET', 'TEXT'], statementInputNames: [], fieldNames: [] },
  ...
  { type: 'motion_move_towards', category: 'Motion', kind: 'statement', summary: 'Move instantly toward an x/y position by a number of steps', inputNames: ['X', 'Y', 'STEPS'], statementInputNames: [], fieldNames: [] },
